...
FOUNDATION_EXTERN NSString * const GPSequenceExceptionName;
FOUNDATION_EXTERN NSString * const GPSequenceExceptionReason_ResultOfFlattenMapBlockMustConformsNSFastEnumeation;
FOUNDATION_EXTERN NSString * const GPSequenceExceptionReason_ZipMethodMustUseOnNSFastEnumerationOfNSFastEnumeration;

@interface GPSequence <T> (Operations)
...
/**
 ...
 @return A new GPSequence object
 */
- (GPSequence *)flatten;
...
/**
 ...
 @return A new GPSequence object
 */
- (GPSequence *)flattenMap:(id<NSFastEnumeration> (NS_NOESCAPE ^)(T item))flattenBlock;

/**
 Appends the elements of anotherSequence to self.
 
 @param anotherSequence another sequece to be appened
 @return A new GPSequenced object
 */
 ...
 */
- (GPSequence<T> *)filter:(BOOL (NS_NOESCAPE ^)(T item))filterBlock;
...
/**
 ...
 @return A new sequence object
 */
- (GPSequence *)map:(id (NS_NOESCAPE ^)(T item))mapBlock;
...
/**
 ...
 @return A new sequence object
 */
- (GPSequence *)mapWithIndex:(id (NS_NOESCAPE ^)(T item, NSUInteger index))mapBlock;
...
/**
 ...
 @return A new sequence object
 */
- (GPSequence<T> *)take:(NSUInteger)count;
 ...
 */
- (GPSequence<T> *)skip:(NSUInteger)count;
...
/**
 ...
 @return A new sequence object
 */
- (GPSequence<T> *)select:(BOOL (NS_NOESCAPE ^)(T item))selectBlock;
...
/**
 ...
 @return A new sequence object
 */
- (GPSequence<T> *)reject:(BOOL (NS_NOESCAPE ^)(T item))rejectBlock;
...
/**
 ...
 @return A new sequence object
 */
+ (GPSequence<GPSequence *> *)zipSequences:(id<NSFastEnumeration>)sequences;
 ...
 */
- (NSDictionary<id<NSCopying>, GPSequence<T> *> *)groupBy:(id<NSCopying> (NS_NOESCAPE ^)(T value))groupBlock;
@end
